...
var _urlbuilderJs = require("./class/urlbuilder.js");
var _urlbuilderJsDefault = parcelHelpers.interopDefault(_urlbuilderJs);
class App {
    constructor(form){
        this.form = form;
    ...
    onSubmit(event) {
        ...
        if (this.preventRequest === false) {
            ...
            const url = (0, _urlbuilderJsDefault.default).getUrl("https://api.agify.io", {
                name: name,
                country_id: country
            });
            fetch(url).then((response)=>response.json()).then((agifyResponse)=>{
                let age = agifyResponse.age;
                if (age === null) {
                    const secondUrl = (0, _urlbuilderJsDefault.default).getUrl("https://api.agify.io", {
                        name: name
                    });
                    fetch(secondUrl).then((response)=>response.json()).then((secondAgifyResponse)=>{
                        this.responseToUser(secondAgifyResponse.age);
                    });
                } else this.responseToUser(age);
            });
        }
    }
    responseToUser(age) {
...
},{"bootstrap":"h36JB","./class/urlbuilder.js":"gssEZ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"h36JB":[function(require,module,exports) {
/*!
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gssEZ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class UrlBuilder {
    ...
    static _getEncodedParams(params) {
        let encodedParams = [];
        for(const prop in params)encodedParams.push(encodeURIComponent(prop) + "=" + encodeURIComponent(params[prop]));
        return encodedParams.join("&");
    }
}
exports.default = UrlBuilder;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6fRhY","8lRBv"], "8lRBv", "parcelRequire16f5")
